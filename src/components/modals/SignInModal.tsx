                  ...
                  <motion.div key="phone" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    ...
                    <form onSubmit={onSendOtp} className="mt-7 space-y-3">
                      <div>
                        ...
                        <div className="mt-1.5 flex h-12 items-center gap-2 rounded-2xl border border-line bg-white px-3 transition-all duration-300 hover:shadow-[0_2px_14px_-4px_rgba(168,135,70,0.4)] focus-within:shadow-[0_4px_20px_-2px_rgba(168,135,70,0.6)] dark:bg-white/5 dark:hover:shadow-[0_2px_14px_-4px_rgba(190,158,95,0.3)] dark:focus-within:shadow-[0_4px_20px_-3px_rgba(190,158,95,0.5)]">
      ...
      {Array.from({ length: LEN }).map((_, i) => {
        ...
        return (
          <input
            ...
            className="h-14 w-full rounded-2xl border-2 border-line bg-white text-center text-xl font-semibold text-ink outline-none transition-all duration-300 hover:shadow-[0_2px_14px_-4px_rgba(168,135,70,0.4)] focus:bg-white focus:shadow-[0_4px_20px_-2px_rgba(168,135,70,0.65)] disabled:opacity-60 dark:bg-white/5 dark:text-white dark:focus:shadow-[0_4px_20px_-3px_rgba(190,158,95,0.5)]"
          />
        );
      })}
    </div>
...
function Field({
  ...
  return (
    <label className="block">
      ...
      <div className="mt-1.5 flex h-12 items-center gap-2 rounded-2xl border border-line bg-white px-4 transition-all duration-300 hover:shadow-[0_2px_14px_-4px_rgba(168,135,70,0.4)] focus-within:shadow-[0_4px_20px_-2px_rgba(168,135,70,0.6)] dark:bg-white/5 dark:hover:shadow-[0_2px_14px_-4px_rgba(190,158,95,0.3)] dark:focus-within:shadow-[0_4px_20px_-3px_rgba(190,158,95,0.5)]">
