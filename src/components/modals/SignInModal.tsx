...
export function SignInModal() {
  ...
  function reset() {
    setFullName(""); setPhone(""); setEmail(""); setPassword(""); setSubmitted(false); setMode("signin");
  }
  ...
  return (
    <AnimatePresence>
      {signin && (
        <ModalShell ariaLabel={mode === "signup" ? "Create account" : "Sign in"} onClose={closeSignin}>
