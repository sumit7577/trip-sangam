...
const WHATSAPP_NUMBER = "917678538192";
const PHONE_NUMBER = "+917678538192";
...
export function ChatBubble() {
  ...
  return (
    <div className="fixed right-3 z-30 flex flex-col items-center gap-2.5 bottom-[calc(env(safe-area-inset-bottom)+84px)] md:right-6 md:gap-3 lg:bottom-6">
      {/* Phone (top of stack) */}
      <motion.a
      ...
      {/* WhatsApp (bottom — primary contact in South Asia) */}
      <motion.a
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        ...
        style={{ boxShadow: "0 12px 32px -8px rgba(37, 211, 102, 0.40)" }}
      >
