...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: u("/lumbini-tour-package-from-raxaul"), lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: u("/janakpur-tour-package-from-raxaul"), lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: u("/manakamana-temple-tour-package"), lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: u("/chitwan-jungle-safari-package"), lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: u("/nepal-honeymoon-package"), lastModified: now, changeFrequency: "weekly", priority: 0.85 },
