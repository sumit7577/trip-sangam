...
// Hover + focus = brighten + a warm gold glow (visible in light AND dark, no hard border).
const FIELD = "flex items-center gap-2 rounded-xl border border-ink/10 bg-white/55 px-3 transition-all duration-300 hover:bg-white hover:shadow-[0_2px_14px_-4px_rgba(168,135,70,0.45)] focus-within:bg-white focus-within:shadow-[0_4px_20px_-2px_rgba(168,135,70,0.65)] dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/[0.07] dark:hover:shadow-[0_2px_14px_-4px_rgba(190,158,95,0.35)] dark:focus-within:bg-white/[0.09] dark:focus-within:shadow-[0_4px_20px_-3px_rgba(190,158,95,0.5)]";
...
function DatePicker({
  ...
  return (
    <div ref={ref} className="relative">
      <Label>{label}</Label>
      <div onClick={openCal} className={cn(FIELD, "h-11 cursor-pointer", open && "bg-white shadow-[0_4px_20px_-2px_rgba(168,135,70,0.65)] dark:bg-white/[0.09] dark:shadow-[0_4px_20px_-3px_rgba(190,158,95,0.5)]")}>
        <span className="shrink-0 text-muted">{icon}</span>
